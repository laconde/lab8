...
// The value 12 is in position number 8 of the list. Explanation: since the array starts at 0, the last element of the array is 15. 15/2 = 7.5, which is rounded to 7. The computer looks for the first middle value, that happens to be 12 in position 8.
// The value 19 is in position number 2 of the list. To find 19 the computer has to find many middle values until it gets to 19. When the computer is going through the three numbers (34,19,19) it gets the middle value 19 which is in position 1 of the array.
