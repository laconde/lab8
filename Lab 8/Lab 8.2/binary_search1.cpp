...
// In C++, dividing integers will always return an integer. So the right side of the statement will store as an integer in the computer memory. The computer does not take into account the decimals, so it will round down. This affects the logic of the program because if you have an even number of elements in the array, you will have two middle numbers, but the computer will consider the smaller middle value as the middle value.
